...
const App = () => (
  <QueryClientProvider client={queryClient}>
    ...
    <img className="justify-center" height={100} width={70} src={"https://res.cloudinary.com/dvvijlfio/image/upload/v1775980156/WhatsApp_Image_2026-04-11_at_11.13.12_mrljkm.jpg"} />
  </QueryClientProvider>
);
